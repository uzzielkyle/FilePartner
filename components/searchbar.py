...
class Searchbar(CTkFrame):
    def __init__(self, *args, 
        ...
        self.lbl_search.grid(row=0, column=0, padx=0, pady=5)
        
        self.entry = CTkEntry(self, placeholder_text=placeholder_text, width=width - 200)
        ...
        self.load_btn.grid(row=0, column=2, padx=0, pady=5)
