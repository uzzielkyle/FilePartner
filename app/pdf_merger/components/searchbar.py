...
class Searchbar(CTkFrame):
    ...
    def __init__(self, *args,
        ...
        self.lbl_search = CTkLabel(
            self, text=label, width=90, text_color='black')
        self.lbl_search.grid(row=0, column=0, padx=0, pady=(10, 5))

        self.entry = CTkEntry(
            self, placeholder_text=placeholder_text, width=self.WIDTH - 210)
        ...
        self.load_btn = CTkButton(
            self, text="Load", width=90, command=self.load, corner_radius=corner_radius)
